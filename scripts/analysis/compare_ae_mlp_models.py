...
def main():
    ...
    print(f"参考脚本: models.deep.ae_mlp_shared 中的 build_ae_mlp_model()")
    ...
    reference_model = build_ae_mlp_model(params)
    print(f"    ✓ 构建成功")
...
保存的模型和 models.deep.ae_mlp_shared 中 build_ae_mlp_model()
函数创建的模型具有相同的架构。
