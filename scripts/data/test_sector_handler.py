"""
Unit tests for sector feature integration in Alpha158_Volatility_TALib_Macro handler.

Validates:
1. Sector parquet data quality (one-hot encoding)
2. Case-insensitive instrument matching (qlib lowercase vs parquet uppercase)
3. End-to-end handler output with sector features
"""
...
class TestSectorParquetData:
    ...
    def test_expected_columns_exist(self):
        """All 11 sector one-hot columns should exist."""
...
# ============================================================================
# 3. End-to-end handler integration
# ============================================================================
...
class TestHandlerIntegration:
    ...
    def test_sector_features_in_handler_output(self):
        """sector handler should produce non-zero sector features in output."""
        self._init_qlib()
